...
router.get("/v3/assignments", (req, res) => {
...
router.post("/v3/assignments", jsonParser, async (req, res) => {
...
router.get("/v3/assignments/:id", async (req, res) => {
...
router.delete("/v3/assignments/:id", async (req, res) => {
...
router.put("/v3/assignments/:id", jsonParser, async (req, res) => {
...
router.post("/v3/assignments/:id/submission", jsonParser, async (req, res) => {
